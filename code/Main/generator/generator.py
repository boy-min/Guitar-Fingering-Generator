...
class Generator:
    ...
    def __get_change_dif(self, sorted_list_1, sorted_list_2):
        ...
        for idx1 in range(len(sorted_list_1)):
            for idx2 in range(len(sorted_list_2)):
                if sorted_list_1[idx1][0] == sorted_list_2[idx2][0]:
                    d = (sorted_list_1[idx1][1] - sorted_list_2[idx2][1]) ** 2 \
                        + (sorted_list_1[idx1][2] - sorted_list_2[idx2][2]) ** 2
                    difficulty += d * self.__ratio[self.__hand.get("length") + 3] * self.__weight[11]
