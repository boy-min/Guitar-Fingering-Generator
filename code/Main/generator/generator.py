...
class Generator:
    def __init__(self, music_=None, size_=None, length_=None):
        ...
        #self.__weight = [100000, 7, 10, 28, 35, 70, 100, 5, 15, 12, 20] for flowerdance
    ...
    def generate(self):
        ...
        flowerdance = [
            ...
            [1],[2],[],[2],[],[],[2,1],[],[4,2],
            [2,1],[4],[],[3],[],[3],[1],[2],[],[],[2],[1],
            [3,2],[1],[4],[1],[3,2],[1],[4],[1],[3],[1],[4],[1],[3],[1],[4],[1],
            [3],[1],[4],[1],[3],[1],[4],[1],[3],[],[],
        ...
        count = 0
        if len(finger_list) == len(windsong):
            for idx in range(len(finger_list)):
                check = False
                for i in range(len(finger_list[idx])):
                    if finger_list[idx][i] + 1 == windsong[idx][i]:
                        continue
                    else:
                        check = True
                        break
